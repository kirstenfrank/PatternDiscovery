...
for (i in 1:50)
    {
    true1[i]<-(list6[[i]][1] %in% largepattern1 &
                  list6[[i]][2] %in% largepattern1
              & list6[[i]][3] %in% largepattern1
              & list6[[i]][4] %in% largepattern1
              & list6[[i]][5] %in% largepattern1
              & list6[[i]][6] %in% largepattern1)
    true2[i]<-(list6[[i]][1] %in% largepattern2 &
                  list6[[i]][2] %in% largepattern2
              & list6[[i]][3] %in% largepattern2
              & list6[[i]][4] %in% largepattern2
              & list6[[i]][5] %in% largepattern2
              & list6[[i]][6] %in% largepattern2)
    }
mean(true1)
mean(true2)
```